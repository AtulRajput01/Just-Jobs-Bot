...
program again, last one will be terminated with the help of pid. If in case the no process exists
with the given process id, simply  pid file will be deleted and a new one with the current pid will be
created...
"""
